...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-agh2dre.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-agh2dre.containers.anotherwebservice.com/
...
```
git clone git@github.com:jssoni14/container-agh2dre.git
cd container-agh2dre
```
...
```
docker attach container-agh2dre
```
